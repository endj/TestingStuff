...
import se.edinjakupovic.client.stuff.simulations.DumpToDiskConcurrent;
...
public class Config {
    ...
    @Primary
    @Bean
    public ReportFetchTest diskDump(ReportClient reportClient, FileWriter fileWriter, ReportRepository reportRepository) {
        return new DumpToDiskConcurrent(reportClient, fileWriter, reportRepository);
    }
